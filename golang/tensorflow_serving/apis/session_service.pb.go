...
func (x *SessionRunRequest) GetFeed() []*core_protos_go_proto.NamedTensorProto {
	if x != nil {
		return x.Feed
	}
	return nil
...
func (x *SessionRunRequest) GetOptions() *core_protos_go_proto.RunOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *SessionRunResponse) GetTensor() []*core_protos_go_proto.NamedTensorProto {
	if x != nil {
		return x.Tensor
	}
	return nil
...
func (x *SessionRunResponse) GetMetadata() *core_protos_go_proto.RunMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_tensorflow_serving_apis_session_service_proto_goTypes = []interface{}{
	...
	(*core_protos_go_proto.NamedTensorProto)(nil), // 3: tensorflow.NamedTensorProto
	(*core_protos_go_proto.RunOptions)(nil),       // 4: tensorflow.RunOptions
	(*core_protos_go_proto.RunMetadata)(nil),      // 5: tensorflow.RunMetadata
}
